...
df0 = pd.read_csv("logs/LoggerBot.log",
...
# print(df0.head())
df = df0.query("PlayerName=='Yz18966'")  # filter a pandas data frame very nicely like an SQL query!
...
plt.legend()
plt.grid()
plt.savefig('training_curves_07.png')
...
plt.title('Accuracy at identifying whether "Yz18966" is a spy as the game progresses')
plt.xlabel('Turn')
plt.ylabel('Accuracy')
plt.grid()
plt.savefig('accuracy_07.png')
...
model.save(filepath="C://Users/12826/Documents/Univerity of Essex/MSc/CE811 Game Artificial "
                    "Intelligence/CE811_Labs/Lab1/log_classifier_02")
